...
def process_image(image: any, languages: List[str], verbosity: int, grade: str, robustness: str, feedback=""):
    chatter = ChatController(Caller=get_caller("gpt-4o"))
    inmsg, outmsg = chatter.chat("Image: ONLY GIVE THE ANSWER. Give me a good standard alt text for the image inputted." + 
                                 ...
                                 f"The length of the alt text should default to no longer than 125 characters, unless otherwise selected.)" + 
